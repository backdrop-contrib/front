...
1. Allows you to specify a custom front page based on
role type using 301 Redirect.
...
3. Expand any of the roles that you want to override the default front page and
    ...
    variables required for that method.
    Once the settings are correct save the form.
