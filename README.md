...
3. Expand the sections corresponding to the roles for which you want to customize the front page.
4. Select the appropriate method of override and fill in the necessary variables for that method.
5. Once the settings are configured correctly, save the form.
6. Enable the 'Front Page Override' checkbox and save the form again to apply the changes. The Front Page module should now be functioning as expected.
7. That's it!
